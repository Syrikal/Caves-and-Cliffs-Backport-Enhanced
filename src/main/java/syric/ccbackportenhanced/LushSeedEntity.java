...
public class LushSeedEntity extends ProjectileItemEntity {
    ...
    public LushSeedEntity(EntityType<? extends LushSeedEntity> type, World world) {
        super(type, world);
    }

    public LushSeedEntity(World world, LivingEntity entity) {
        super(CCBEEntityTypes, entity, world);
    }
    ...
    private IParticleData getParticle() {
        ...
        return (IParticleData) new ItemParticleData(ParticleTypes.ITEM, itemstack);
    }
