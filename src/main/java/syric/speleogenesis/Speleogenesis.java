...
@Mod("speleogenesis")
public class Speleogenesis
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MODID = "speleogenesis";

    public Speleogenesis() {
        ...
        SpeleogenesisBlocks.register(modEventBus);
        SpeleogenesisItems.register(modEventBus);
        SpeleogenesisEntityTypes.register(modEventBus);
        SpeleogenesisBlockTags.init();
    ...
    public void loadComplete(FMLLoadCompleteEvent event) {
        ComposterBlock.COMPOSTABLES.put(SpeleogenesisBlocks.GLOWBERRY_SACK.get().asItem(), 1F);
    }
